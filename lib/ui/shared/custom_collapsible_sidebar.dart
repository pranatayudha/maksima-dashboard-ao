...
import 'custom_collapsible_item.dart';
...
class CustomCollapsibleSidebar extends StatefulWidget {
  ...
  final bool showToggleButton,
      ...
      showTitle,
      collapseOnBodyTap;
  final List<CustomCollapsibleItem> items;
  final double height,
      minWidth,
      maxWidth,
      borderRadius,
  ...
  _CustomCollapsibleSidebarState createState() =>
      _CustomCollapsibleSidebarState();
}

class _CustomCollapsibleSidebarState extends State<CustomCollapsibleSidebar>
  ...
  @override
  void didUpdateWidget(covariant CustomCollapsibleSidebar oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        if (!ResponsiveHelpers.isMobile(context)) sidebar,
                    ...
                    Center(
                      child: InkWell(
                        onTap: () {
                          _isCollapsed = !_isCollapsed;
                          var endWidth =
                              _isCollapsed ? widget.minWidth : tempWidth;
                          _animateTo(endWidth);
                        },
                        child: const Padding(
          ...
          children: [
            ...
            Expanded(
              child: CollapsibleItemWidget(
                ...
                scale: _fraction,
                leading: Image.asset(
                  item.isSelected ? item.iconSelected : item.iconUnSelected,
                  scale: 3,
                ),
                title: item.text,
